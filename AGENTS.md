...
All agents must read `CLAUDE.md` before starting work in this repository.
...
- The repository root is the canonical project. `.zlagent/`, `.env`, and
  `workspace/logs/` or `workspace/runtime/` are local data, never source authority.
