...
def _build_tool_registry(
    *,
    ...
    if getattr(settings, "opengui_enabled", False):
        tool_registry.register(OpenGUITool(
            base_url=settings.opengui_base_url,
            timeout_seconds=settings.opengui_timeout_seconds,
        ))
