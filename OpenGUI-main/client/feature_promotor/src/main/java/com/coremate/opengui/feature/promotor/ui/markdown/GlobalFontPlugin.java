...
public class GlobalFontPlugin extends AbstractMarkwonPlugin {
    private final Typeface globalTypeface;

    public GlobalFontPlugin(Typeface typeface) {
    ...
    public void configureSpansFactory(@NonNull MarkwonSpansFactory.Builder builder) {
        builder.setFactory(Paragraph.class, new SpanFactory() {
            ...
            public Object getSpans(
                ...
                return new CustomTypefaceSpan(globalTypeface);
            }
        });
    }
}