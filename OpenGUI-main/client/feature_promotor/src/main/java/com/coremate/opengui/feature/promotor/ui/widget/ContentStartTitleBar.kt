...
import com.coremate.opengui.feature.promotor.databinding.ViewContentStartTitleBarBinding


class ContentStartTitleBar @JvmOverloads constructor(
    context: Context,
    ...
    private val binding: ViewContentStartTitleBarBinding = ViewContentStartTitleBarBinding.inflate(
    ...
    fun hideSearchWidget() {
        ...
        animator.addUpdateListener { animation ->
            ...
            layoutParams.marginStart = this@ContentStartTitleBar.width - width
            searchContainer.layoutParams = layoutParams
