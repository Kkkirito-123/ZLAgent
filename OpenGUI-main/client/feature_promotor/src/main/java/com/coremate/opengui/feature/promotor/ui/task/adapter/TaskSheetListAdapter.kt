...
class TaskSheetListAdapter(private val fragmentManager: FragmentManager? = null) :
    RecyclerView.Adapter<TaskSheetListAdapter.TaskCategoryViewHolder>() {

    val data: MutableList<TaskTemplatesResp> = mutableListOf()
    var listener: TaskSheetListAdapterListener? = null
    ...
    override fun onCreateViewHolder(
        ...
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.view_sheet_task_item, parent, false)
...
interface TaskSheetListAdapterListener {
